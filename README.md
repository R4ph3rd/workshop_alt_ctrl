...
Pour utiliser le mpr, on a besoin des libraries **Wire** **MPR121** que l'on appelle ainsi après les avoir téléchargées depuis l'IDE Arduino : 
```C++
#include <Wire.h>
